...
@Component({
  selector: 'app-billingprinthistory',
  templateUrl: './billingprinthistory.component.html',
  styleUrls: ['./billingprint.scss'],
  providers: [MessageService]
})
export class BillingprintHistoryComponent  implements OnInit, OnChanges{
