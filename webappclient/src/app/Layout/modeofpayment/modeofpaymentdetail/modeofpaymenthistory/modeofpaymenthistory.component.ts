...
@Component({
  selector: 'app-modeofpaymenthistory',
  templateUrl: './modeofpaymenthistory.component.html',
  styleUrls: ['./modeofpayment.scss'],
  providers: [MessageService]
})
export class ModeofpaymentHistoryComponent implements OnInit {
  selectedRowData: any[];
  user: any = [];
  content: any[] = [];
  ...
  ngOnInit(): void {
    ...
    this.masterService.getAllpaymentmsater().subscribe(
      data => {
