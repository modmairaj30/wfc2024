...
@Component({
  selector: 'app-contralocationhistory',
  templateUrl: './contralocationhistory.component.html',
  styleUrls: ['./contralocation.scss'],
  providers: [MessageService]
})
export class ContralocationHistoryComponent implements OnInit {
  selectedRowData: any[];
  user: any = [];
  content: any[] = [];
  ...
  @Output()
  editContralocationentry = new EventEmitter();
  ...
  constructor(private masterService: MasterService, private messageService: MessageService) {
    this.cols = [
      ...
      { field: 'telePhone', header: 'Tele Phone' },
      ];
  ...
  ngOnInit(): void {
    ...
    this.masterService.getAllContralocation().subscribe(
      data => {
  ...
  editProduct(product: any) {
    this.editContralocationentry.emit(product);
  }
