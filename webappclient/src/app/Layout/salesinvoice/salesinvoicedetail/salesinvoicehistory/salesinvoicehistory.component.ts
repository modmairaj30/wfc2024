...
@Component({
  selector: 'app-salesinvoicehistory',
  templateUrl: './salesinvoicehistory.component.html',
  styleUrls: ['./salesinvoice.scss'],
  providers: [MessageService]
})
export class SalesinvoiceHistoryComponent  implements OnInit{
  ...
  @Output()
  editSalesinvoiceEntry = new EventEmitter();
  ...
  ngOnInit():void {
    ...
    editProduct(product: any) {
      ...
      this.editSalesinvoiceEntry.emit(product);
    }
