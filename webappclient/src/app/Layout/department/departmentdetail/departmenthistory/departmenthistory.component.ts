...
@Component({
  selector: 'app-departmenthistory',
  templateUrl: './departmenthistory.component.html',
...
export class DepartmentHistoryComponent implements OnInit {
  ...
  @Output()
  editDepartmenttry = new EventEmitter();
  ...
  editProduct(department: any) {
    this.editDepartmenttry.emit(department);
  }
