...
@Component({
  selector: 'app-stocktransferrequisitionhistory',
  templateUrl: './stocktransferrequisitionhistory.component.html',
  styleUrls: ['./stocktransferrequisition.scss'],
  providers: [MessageService]
})
export class StocktransferrequisitionHistoryComponent  implements OnInit{
