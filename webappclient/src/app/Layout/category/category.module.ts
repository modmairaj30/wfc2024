...
import { CategoryentryComponent } from './categorydetail/categoryentry/categoryentry.component';
import { CategoryHistoryComponent } from './categorydetail/categoryhistory/categoryhistory.component';
...
@NgModule({
  ...
  declarations: [
    CategoryComponent,CategorydetailComponent,CategoryentryComponent,CategoryHistoryComponent
  ],
