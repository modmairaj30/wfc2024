...
@Component({
  selector: 'app-productgroupshistory',
  templateUrl: './productgroupshistory.component.html',
  styleUrls: ['./productgroups.scss'],
  providers: [MessageService]
})
export class ProductgroupsHistoryComponent implements OnInit {
  selectedRowData: any[];
  user: any = [];
  content: any[] = [];
  ...
  ngOnInit(): void {
    ...
    this.masterService.getAllproductGroup().subscribe(
      data => {
