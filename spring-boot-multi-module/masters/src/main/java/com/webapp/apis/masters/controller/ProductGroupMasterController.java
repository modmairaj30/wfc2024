...
public class ProductGroupMasterController {
	...
	@Inject
	ProductGroupMasterService productGroupMasterService;

	@RequestMapping(value = "/saveProductGroupMaster", method = RequestMethod.POST)
	public ResponseWrapper<String> saveProductGroupMaster(
			@RequestBody ProductGroupMasterBeanForm productGroupMasterBeanForm) {
		String flag = productGroupMasterService.saveProductGroupMaster(productGroupMasterBeanForm);
	...
	@RequestMapping(value = "/getAllProductGroup", method = RequestMethod.GET)
	public ResponseWrapper<List<ProductGroupMasterBeanForm>> getAllDepartmentMasters() {
		List<ProductGroupMasterBeanForm> forms = productGroupMasterService.getAllProductGroup();
		return new ResponseWrapper<List<ProductGroupMasterBeanForm>>(null, HttpStatus.OK, "", forms);
