...
@RestController
@RequestMapping(value = "jasperreport/report")
public class JasperReportController {
	...
	public void getRpt1(HttpServletResponse response, ReportInput reportInput)
		...
		LOGGER.info("JasperReportController's getRpt1 method");
		...
		case ReportConstant.STOCK_VERIFICATION:
			jasperStream = new FileInputStream(new File(filePath + "jasperreports/stock_verification.jrxml"));
			// jasperStream =
	...
	public void getPrint(HttpServletResponse response, ReportInput reportInput)
			throws JRException, IOException, SQLException {
		LOGGER.info("JasperReportController's getRpt1 method");
		...
		case ReportConstant.STOCK_VERIFICATION:
			jasperStream = new FileInputStream(new File(filePath + "jasperreports/invoice.jrxml"));
			// jasperStream =
			// this.getClass().getResourceAsStream("/jasperreports/stock_verification.jrxml");
		...
		//	params.put("toDate", toDate);
			//params.put("locationId", reportInput.getLocationId());
			params.put("id", reportInput.getReportId());
			LOGGER.info("params:-" + params);
