...
public class InvoiceDet implements Serializable {
    ...
    public InvoiceDet(Integer id) {
        this.id = id;
    }

    public InvoiceDet(Integer id, String productName) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof InvoiceDet)) {
            return false;
        }
        InvoiceDet other = (InvoiceDet) object;
