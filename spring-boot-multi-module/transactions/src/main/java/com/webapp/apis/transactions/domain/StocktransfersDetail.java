 ...
 */
@Entity
@Table(name = "stocktransfers_detail")
public class StocktransfersDetail implements Serializable {
    ...
    @Column(name = "from_c_no")
    private Integer fromCNo;
    @Column(name = "to_c_no")
    private Integer toCNo;
    @Column(name = "qty")
...
//	public Stocktransfers getStockTransfer() {
//		return stockTransfer;
//	}
//
//	public void setStockTransfer(Stocktransfers stockTransfer) {
...
//	}
	...
	public Stocktransfers getBaseId() {
		return baseId;
	}

	public void setBaseId(Stocktransfers baseId) {
		this.baseId = baseId;
	}
	...
	public Integer getFromCNo() {
		return fromCNo;
	}

	public void setFromCNo(Integer fromCNo) {
		this.fromCNo = fromCNo;
	}

	public Integer getToCNo() {
		return toCNo;
	}

	public void setToCNo(Integer toCNo) {
		this.toCNo = toCNo;
	}
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StocktransfersDetail)) {
            return false;
        }
        StocktransfersDetail other = (StocktransfersDetail) object;
    ...
    public String toString() {
        return "com.mycompany.javaapplication1.StocktransfersDetail[ id=" + id + " ]";
    }
