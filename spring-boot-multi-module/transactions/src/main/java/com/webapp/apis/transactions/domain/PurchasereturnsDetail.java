 ...
 */
@Entity
@Table(name = "purchasereturns_detail")
public class PurchasereturnsDetail implements Serializable {
    ...
    @ManyToOne
    private Purchasereturns baseId;
    

    public PurchasereturnsDetail() {
    }

    public PurchasereturnsDetail(Integer id) {
        this.id = id;
    }

    public PurchasereturnsDetail(Integer id, String productName) {
        this.id = id;
	...
	public Purchasereturns getBaseId() {
		return baseId;
	}

	public void setBaseId(Purchasereturns baseId) {
		this.baseId = baseId;
	}
    ...
    public String toString() {
        return "com.mycompany.PurchasereturnsDetail[ id=" + id + " ]";
    }
