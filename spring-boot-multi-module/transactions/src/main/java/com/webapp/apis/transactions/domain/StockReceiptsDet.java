 ...
 */
@Entity
@Table(name = "stock_receipts_det")
public class StockReceiptsDet implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StockReceiptsDet)) {
            return false;
        }
        StockReceiptsDet other = (StockReceiptsDet) object;
    ...
    public String toString() {
        return "com.mycompany.javaapplication1.StockReceiptsDet[ id=" + id + " ]";
    }
