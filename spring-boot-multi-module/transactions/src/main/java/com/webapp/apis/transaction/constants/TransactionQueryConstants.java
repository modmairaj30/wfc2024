package com.webapp.apis.transaction.constants;
...
public class TransactionQueryConstants {
	...
	public static final String REPORT_QUERY = "SELECT creation_date, heat_id, strand_no, billet_ord, highest_defect_type,assigned_grade, "
	...
	public static final String SPEED_QUERY = "select measure_date,heat_id, measure_no, superheat, tundish_weight, speed_strand_1,speed_strand_2, speed_strand_3, \r\n"
			+ "  speed_strand_4, speed_strand_5,speed_strand_6, speed_strand_7, speed_strand_8  from cwarel3.rpt_heat_measure  \r\n"
